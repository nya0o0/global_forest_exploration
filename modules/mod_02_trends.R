...
mod_02_trends_server <- function(id, country_loss) {
  moduleServer(id, function(input, output, session) {
    ...
    EVENT_INSIGHTS <- list(
      "Brazil" = "Brazil experienced a sharp decline in forest loss after the launch of the PPCDAm action plan in 2004, reaching its lowest point around 2012. However, loss rebounded significantly after 2016 due to policy relaxation and increased pressures.",
      ...
      "Russia" = "Russia has the highest fire-related tree-cover loss among all countries. Severe boreal forest wildfires occurred in multiple years, notably 2012 and 2019–2021, contributing to large-scale loss in the taiga.",
      ...
      "Democratic Republic of the Congo" = "The country has exhibited a strong upward trend in forest loss since around 2012. Following a dip in the early 2010s, loss rates have roughly doubled and stayed high, mainly due to expanding small-scale agriculture, slash-and-burn practices, and charcoal production. Weak governance, population growth, and conflict in eastern regions continue to exacerbate the pressure on its vast rainforests.",
      ...
      "Madagascar" = "Madagascar has one of the world's highest proportional forest loss rates. Loss accelerated dramatically in the mid-2010s, reaching record highs around 2014 and 2017, largely due to slash-and-burn agriculture (tavy), illegal rosewood logging, and charcoal production. Rates eased somewhat after 2018 following increased conservation efforts and enforcement, but the pressure on its unique biodiversity remains severe.",
      "Laos" = "Laos experienced rapid and sustained forest loss from the early 2000s to around 2016, primarily driven by large-scale rubber plantations and cash crop expansion (often linked to foreign investment). Loss peaked in the mid-2010s, then moderated slightly after 2016 due to government restrictions on new plantations and strengthened forest protection policies, but rates remain elevated.",
      "Myanmar" = "Myanmar experienced increased logging and agricultural pressure following political transitions.",
      "Côte d'Ivoire" = "Côte d'Ivoire has high rates of forest loss, largely driven by cocoa plantation expansion.",
